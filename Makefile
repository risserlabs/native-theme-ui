...
.PHONY: prepare
prepare:
	@sed -i 's/UseThemeFunction, //g' node_modules/dripsy/lib/typescript/css/index.d.ts
	@sed -i 's/UseThemeFunction/any/g' node_modules/dripsy/lib/typescript/css/index.d.ts
	@sed -i 's/ResponsiveSSRStyles | undefined/any/g' node_modules/dripsy/lib/typescript/css/index.d.ts
	@sed -i "s/P\['style'] extends \[] ? P\['style']\[0] : P\['style']/any/g" node_modules/dripsy/lib/typescript/css/types.d.ts
